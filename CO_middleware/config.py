...
class Config:
    ...
    FETCH_MASTER_INTERVAL_MINUTES = int(os.getenv('FETCH_MASTER_INTERVAL_MINUTES', '30'))

    # Daily master sync configuration
    MASTER_SYNC_TIME = os.getenv('MASTER_SYNC_TIME', '10:00')
    ...
    def reload_from_env(cls):
        ...
        cls.FETCH_MASTER_INTERVAL_MINUTES = int(os.getenv('FETCH_MASTER_INTERVAL_MINUTES', '30'))
        cls.MASTER_SYNC_TIME = os.getenv('MASTER_SYNC_TIME', '10:00')
        cls.MASTER_SYNC_FAILURE_RETRY_MINUTES = int(os.getenv('MASTER_SYNC_FAILURE_RETRY_MINUTES', '30'))
