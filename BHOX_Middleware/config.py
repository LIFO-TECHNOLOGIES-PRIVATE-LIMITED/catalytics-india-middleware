"""
Configuration loader for BHOX Middleware
...
def _normalize_sqlite_db_path(raw: str | None) -> str:
    ...
    """
    entity_name = os.getenv('ENTITY_NAME', 'bhox')
...
def _normalize_tally_db_path(raw: str | None) -> str:
    ...
    company_name = os.getenv('TALLY_COMPANY') or os.getenv('ENTITY_NAME', 'bhox')
...
class Config:
    """Configuration class for BHOX Middleware"""
    ...
    # Invoice delivery-reference filter
    # Set false if Tally invoices don't use BASICORDERREF / OTHERREFERENCE
    REQUIRE_DELIVERY_REF = os.getenv('REQUIRE_DELIVERY_REF', 'true').lower() == 'true'
    ...
    POSTGRES_DB = os.getenv('POSTGRES_DB', 'bhox')
    POSTGRES_USER = os.getenv('POSTGRES_USER', 'postgres')
    POSTGRES_PASSWORD = os.getenv('POSTGRES_PASSWORD', '')

    # Logging
    LOG_LEVEL = os.getenv('LOG_LEVEL', 'INFO')
    LOG_FILE = str(BASE_DIR / os.getenv('LOG_FILE', 'logs/bhox.log'))
...
if __name__ == '__main__':
    # Test configuration
    print("=== BHOX Middleware Configuration ===")
