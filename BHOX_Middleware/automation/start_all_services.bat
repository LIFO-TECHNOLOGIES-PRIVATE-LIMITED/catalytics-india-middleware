@echo off
REM Start all BHOX middleware services
REM Run this at system startup

cd /d "%~dp0.."

echo ============================================================
echo Starting BHOX Middleware Services
echo ============================================================
echo.
...
start "BHOX - Invoice Fetch" /MIN cmd /c "%~dp0continuous_fetch_invoices.bat"
...
start "BHOX - Sync to Catalytics" /MIN cmd /c "%~dp0continuous_sync.bat"
