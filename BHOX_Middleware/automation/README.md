# BHOX Middleware - Automation Scripts

## Overview

This folder contains automation scripts for running the BHOX middleware on Windows.
...
- `BOL_Gas_Fetch_Master_Data` - Every 10 minutes
- `BOL_Gas_Fetch_Invoices_1` - Every minute at :00
- `BOL_Gas_Fetch_Invoices_2` - Every minute at :30
- `BOL_Gas_Sync_To_Catalytics_1` - Every minute at :00
- `BOL_Gas_Sync_To_Catalytics_2` - Every minute at :30
...
| Log File | Content |
|----------|---------|
| `bhox.log` | Main application log (fetch & sync) |
