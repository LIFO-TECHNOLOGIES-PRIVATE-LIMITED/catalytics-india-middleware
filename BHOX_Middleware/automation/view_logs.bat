...
cls
echo ============================================================
echo BHOX MIDDLEWARE - LOG VIEWER
echo ============================================================
echo.
echo Select log to view:
echo.
echo 1. Main Application Log (bhox.log)
...
if "%choice%"=="6" (
    ...
    echo.
    echo [bhox.log]
    powershell -command "Get-Content logs\bhox.log -Tail 10 -ErrorAction SilentlyContinue"
    echo.
