...
cls
echo ============================================================
echo BOL MIDDLEWARE - LOG VIEWER
echo ============================================================
echo.
echo Select log to view:
echo.
echo 1. Main Application Log (bol.log)
...
if "%choice%"=="6" (
    ...
    echo.
    echo [bol.log]
    powershell -command "Get-Content logs\bol.log -Tail 10 -ErrorAction SilentlyContinue"
    echo.
