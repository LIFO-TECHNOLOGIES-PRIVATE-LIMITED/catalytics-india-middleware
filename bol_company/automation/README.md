# BOL Middleware - Automation Scripts

## Overview

This folder contains automation scripts for running the BOL middleware on Windows.
...
| Log File | Content |
|----------|---------|
| `bol.log` | Main application log (fetch & sync) |
