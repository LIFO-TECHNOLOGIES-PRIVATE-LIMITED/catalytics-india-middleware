...
class SyncVerifier:
    ...
    def verify_dc_by_number(self, dc_no, expected_date=None, expected_customer=None):
        ...
        query = sql.SQL(
            ...
            # Catalytics PostgreSQL uses the public schema with dotted table names
            # e.g. public."transaction.delivery_challan" — use single-arg Identifier
            # so psycopg2 generates: "transaction.delivery_challan" (not "transaction"."delivery_challan")
