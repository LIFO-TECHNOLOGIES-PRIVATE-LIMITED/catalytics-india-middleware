@echo off
REM Start all Arasan Gas middleware services
REM Run this at system startup

cd /d "%~dp0.."

echo ============================================================
echo Starting Arasan Gas Middleware Services
echo ============================================================
echo.
...
start "Arasan Gas - Invoice Fetch" /MIN cmd /c "%~dp0continuous_fetch_invoices.bat"
...
start "Arasan Gas - Sync to Catalytics" /MIN cmd /c "%~dp0continuous_sync.bat"
